...
const int OFFSET[] = {1350, 1465, 700, 1372, 1550, 1366, 1333};// normally around 1500 except for elbow and gripper
...
const int MIN[] = {575, 538, 500, 544, 544, 544, 1299};// must not be below 544
